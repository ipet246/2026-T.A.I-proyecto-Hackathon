# Proyecto T.A.I - Tu Armazón Ideal - Hackathon 2026
...
La página incluye un catálogo de armazones donde se pueden consultar características como:
...
El objetivo de T.A.I es facilitar la elección de armazones mediante una herramienta digital que combine inteligencia artificial y preferencias personales para ofrecer recomendaciones personalizadas.

##Tecnologías utilizadas

HTML y CSS: estructura y diseño de la página.
PHP: procesamiento del sitio.
MySQL: almacenamiento de datos.
Python: análisis de imágenes.
MediaPipe: detección de puntos faciales.
NumPy: procesamiento y cálculo de las medidas del rostro.
XAMPP: entorno de desarrollo local.

##Este proyecto fue desarrollado de manera conjunta por las especialidades de Programación y Óptica.

La especialidad de Óptica aportó sus conocimientos sobre los armazones, sus características y los criterios utilizados para su selección. Por otro lado, Programación se encargó del desarrollo de la página web, la implementación del sistema de recomendación, el análisis facial y la integración de las distintas tecnologías utilizadas en el proyecto.
